interface searchBarProps {
    ...
    setPosts: (value: {title: string, description: string, date: string}[]) => void
...
export const SearchBar = ({dataPosts, setPosts, setCurrentPage}: searchBarProps) => {
    ...
    const handleInput = (event: any) => {
        ...
        const newPosts = (newSearch != '') ? dataPosts.filter((post) => post.title.toLowerCase().includes(newSearch.toLowerCase()))
	    : dataPosts
        setPosts(newPosts)
    }
